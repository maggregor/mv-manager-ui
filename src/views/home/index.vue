<template>
  <div :class="$style.container">
    <div class="text-black text-weight-600 font-size-36">Hello {{ username }},</div>
    <div class="mb-5 text-gray-7 text-weight-300 font-size-18">
      <div>
        You are connected to your
        <span class="google-font text-weight-400 mr-2">Google Cloud Platform™</span>
    ...
    <div
      ...
      class="mb-3 mt-5 text-black text-weight-200 font-size-24"
    >
      Activate the optimizer on your projects
    </div>
    <a-skeleton :loading="isProjectLoading">
      <ProjectCard
